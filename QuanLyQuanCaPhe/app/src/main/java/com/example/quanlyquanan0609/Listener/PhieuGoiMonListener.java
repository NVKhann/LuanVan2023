...
public class PhieuGoiMonListener implements ValueEventListener {
    private GoiMonAdapter.MyViewHolder holder;
    private BanAnClass banAnClass;
    private Context context;

    public PhieuGoiMonListener(GoiMonAdapter.MyViewHolder holder, BanAnClass banAnClass, Context context) {
        this.holder = holder;
